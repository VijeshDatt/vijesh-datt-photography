  ...
  methods: {
    ...
    getHomeImages: function getHomeImages() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().get('/api/home').then(function (res) {
        return _this.images = res.data.data;
      })["catch"](function (e) {
        return console.log(e);
      });
    },
    openImage: function openImage(image) {
      this.image = "/assets/images/home/".concat(image);
      this.dialog = true;
    },
          ...
          scopedSlots: _vm._u([{
            ...
            fn: function fn(_ref2) {
              ...
              return [_c("v-card", {
                ...
                staticClass: "rounded-xl",
                attrs: {
                  src: "/assets/images/home/".concat(item.filename),
                  alt: item.filename
                },
                on: {
                  load: function load($event) {
                    return _vm.loaded(item.filename);
                  }
                }
                ...
                on: {
                  click: function click($event) {
                    return _vm.openImage(item.filename);
                  }
                }
              }, [_c("v-icon", {
                attrs: {
              ...
              }, [_vm._v("fa-up-right-and-down-left-from-center")])], 1) : _vm._e()], 1)], 1)];
            }
          }], null, true)
        })], 1)];
      }
